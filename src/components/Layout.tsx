    ...
    <div className="min-h-screen bg-background text-foreground flex overflow-hidden font-sans">
      ...
      <aside className="hidden md:flex fixed left-4 top-4 bottom-4 w-64 flex-col bg-card rounded-[2rem] border border-white/[0.05] z-30 shadow-2xl">
        <div className="flex items-center gap-3 px-8 py-8">
          <div className="w-10 h-10 rounded-xl overflow-hidden shadow-lg border border-white/10 group-hover:scale-110 transition-transform duration-500">
            <img src="/screen.png" alt="Atelier Logo" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-lg font-bold tracking-tight">Atelier</h1>
        </div>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-16 bg-background/80 backdrop-blur-xl flex items-center justify-between px-6 z-40 border-b border-white/[0.05]">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg font-bold">Atelier</h1>
        </div>
